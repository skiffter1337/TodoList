...
export const AddItemFormErrorStory = (args: PropsType) => {
  ...
  const onKeyDownTask = (event: KeyboardEvent<HTMLInputElement>) =>
    event.key === 'Enter' && title.length < 15 && addItem();
  ...
  return (
    <div>
      ...
      />
      <IconButton disabled={inputButtonDisabling} onClick={addItem}>
        +
      </IconButton>
